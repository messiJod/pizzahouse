...
{{--            @endif--}}
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="flex flex-col justify-center pt-8 sm:justify-start sm:pt-0 text-center">
           ...
           <div class="my-2">
               <a href="{{url('/testimonial')}}" class="bg-white inline-block mx-auto text-xl p-6 rounded-2xl hover:bg-red-600 hover:text-white transition-all ">Testimonial Page</a>
           </div>
        </div>
